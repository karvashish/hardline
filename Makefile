...
COVER_PACKAGES := ./cmd/hardline ./cmd/profiletool ./internals/apply ./internals/cli ./internals/connection ./internals/plan ./internals/rollback ./internals/verify ./pkg/profile
